...
function buildMyLMSEvents(): Array<MyLMSEvent> {
...
function getMyLMSEventType(event: string): MyLMSEventType {
...
function isSpecialTypeOfEvent(event: string) {
...
function buildCalendarNav(calendar: Calendar) {
...
function buildCalendar(events: MyLMSEvent[]) {
